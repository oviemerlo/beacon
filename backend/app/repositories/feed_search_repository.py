...
from app.repositories.broadcast_repository import apply_audience_filters
...
async def search_history(
    ...
    echo_stmt = apply_audience_filters(echo_stmt, Broadcast.id, tag_ids, courses)
    ...
    reply_stmt = apply_audience_filters(reply_stmt, Broadcast.parent_broadcast_id, tag_ids, courses)
    ...
    message_stmt = apply_audience_filters(message_stmt, root_id, tag_ids, courses)
